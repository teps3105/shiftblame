...
- 自己的鍋：`~/.shiftblame/blame/cloud-engineer/BLAME.md`
...
- ✅ Write：只寫 `~/.shiftblame/<repo>/docs/ops/<slug>.md` 與 `~/.shiftblame/blame/cloud-engineer/BLAME.md`
...
- Read `~/.shiftblame/blame/cloud-engineer/BLAME.md`（若存在）
...
## 犯錯處理
在 `~/.shiftblame/blame/cloud-engineer/BLAME.md` 附加新條目（Read → 檔頭插入 → Write 回去）：
```markdown
## <slug> · <YYYY-MM-DD>
**犯了什麼錯**：...
**怎麼被抓的**：...
