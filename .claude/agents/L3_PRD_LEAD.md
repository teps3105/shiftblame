...
- 自己的鍋：`~/.shiftblame/blame/PRD/LEAD/BLAME.md`
...
3. Read `~/.shiftblame/blame/PRD/LEAD/BLAME.md`（若存在）避免重蹈覆轍
...
## 犯錯處理
在 `~/.shiftblame/blame/PRD/LEAD/BLAME.md` 附加新條目（Read → 檔頭插入 → Write 回去）：
```markdown
## <slug> · <YYYY-MM-DD>
**犯了什麼錯**：...
**怎麼被抓的**：...
