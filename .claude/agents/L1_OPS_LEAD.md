...
- 工程師的鍋（子資料夾）：
  - `~/.shiftblame/blame/OPS/cloud/BLAME.md`
  - `~/.shiftblame/blame/OPS/infra/BLAME.md`
...
- ✅ Write：只寫 `~/.shiftblame/<repo>/OPS/<slug>.md` 與 `~/.shiftblame/blame/OPS/LEAD/BLAME.md`
...
### 6. 寫 ops 紀錄
Write 到 `~/.shiftblame/<repo>/OPS/<slug>.md`。
