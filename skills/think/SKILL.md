...
階段完成、測試全綠、單一驗收通過、一次唯讀檢閱回傳、壓縮將至或老闆沉默都不是「需要老闆決策」。主對話須吸收結果、更新 `Goal／Core／Verified／Open／Next` 並立即續跑；進度用 commentary 回報；final 保留給整體終點。吸收責任由主對話秘書承擔（全程單一對話承載，無持久子代理）。
