...
建立 QA 任務前另有研究前置條件：管理者必須先完成本輪研究，確認「本輪使用者想實現什麼功能」、現有系統相關背景、可採用/不可採用的既有 ROADMAP 項目、以及本輪明確不做的事項。未完成研究不得建立 QA task.md。
...
**QA 前置研究**：若目標部門為 QA，管理者必須先完成研究並把研究摘要寫入 `task.md` 的「上游輸入」。研究摘要至少包含：
