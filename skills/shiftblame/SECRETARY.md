...
2. 確認項目：最後部門報告完整性、worktree 變更與 task.md 一致、三方 CLI 均有回報
3. `clarify` 呈報收尾結果：
...
| CLI 員工 | 自己子目錄的 proposal.md、result.md |
...
- **約束禁止直接修改 skill 目錄**：工作樹路徑必須指向 slug 層級 worktree，歸檔後由秘書同步
