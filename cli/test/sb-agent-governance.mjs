...
assert.match(skill, /version: "1\.7\.0"/);
...
for (const file of ['AUDIT.md', 'RESEARCH.md', 'PLAN.md', 'TEST.md', 'BUILD.md', 'VERIFY.md']) {
  ...
  assert.match(reference, /revision: 1\.7\.0/);
}
