...
最新架構變更：新增常識修正流程規則，確立各部門常識與秘書常識的標準修正流程（各部門常識由對應部門 PROXY 共識後秘書修正；秘書常識僅限 MIS 階段修正，需 MIS 討論複核）。
...
| v5.1.4 | 閘門「繼續」改為同 turn 推進、MIS 新增框架定義檔同步更新約束、新增權限提升協議 |
| v5.1.5 | 新增常識修正流程規則（各部門常識 + 秘書常識）、SKILL.md 新增常識修正指引 |
